...
export default function HomePageClient({ stats }: { stats: Stats }) {
  ...
  return (
    <div className="min-h-screen" style={{backgroundColor:"#FFFFFF"}}>
      ...
      {/* ── HERO CENTERED ── */}
      <div className="min-h-[calc(100vh-73px)] flex flex-col items-center justify-center px-10 lg:px-16 py-12 relative overflow-hidden">
        ...
        <h1 className="text-5xl lg:text-6xl font-black leading-tight mb-6 text-center" style={{color:"#0F172A"}}>
          Online ta'lim<br /><span style={{color:"#94A3B8"}}>yangi bosqichda.</span>
        </h1>
        <p className="text-lg leading-relaxed max-w-md mb-8 text-center" style={{color:"#475569"}}>
